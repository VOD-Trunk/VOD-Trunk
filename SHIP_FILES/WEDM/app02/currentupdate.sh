...
/usr/bin/curl -s -H "Authorization:${APIKEY}" "http://admin.iptv.wedmdomain.hal/location/private/refreshcurrent" >>/root/weatherupdate/refreshcurrent.log 2>&1

#echo >>/root/weatherupdate/refreshforecast.log
#date >>/root/weatherupdate/refreshforecast.log
#/usr/bin/curl -s -H "Authorization:${APIKEY}" "http://admin.iptv.wedmdomain.hal/location/private/refreshforecast" >>/root/weatherupdate/refreshforecast.log 2>&1
