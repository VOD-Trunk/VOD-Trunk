...
ERROR_FILE='/home/vod/tmp/errors'
CONTENT='/home/vod/tmp/email.txt'
TEMP='/home/vod/tmp/temp.txt'
TEMP2='/home/vod/tmp/temp2.txt'
HEALTH_REPORTS='/home/vod/Health_Reports'
BODY='/home/vod/properties/body.txt'

rm -f $CONTENT

echo "Ship_name Stopped_service DB_replication_broken Media_storage_issue App_storage_issue Hard_disk_issue app01_load app02_load media01_load media02_load nfs_read_only Storage_failover Timezone Content_usage_issue" >> $CONTENT
...
BEGIN{
    ...
    for(i=1;i<=NF;i++)
        ...
        else if($i == "Ship_name" || $i == "Stopped_service" || $i == "DB_replication_broken" || $i == "Media_storage_issue" || $i == "App_storage_issue" || $i == "Hard_disk_issue" || $i == "app01_load" || $i == "app02_load" || $i == "media01_load" || $i == "media02_load" || $i == "nfs_read_only" || $i == "Storage_failover" || $i == "Timezone" || $i == "Content_usage_issue" || $i == "Britannia" || $i == "Caribbean" || $i == "Coral" || $i == "Crown" || $i == "Diamond" || $i == "Emerald" || $i == "Encore" || $i == "EUDM" || $i == "Grand" || $i == "OSDM" || $i == "KODM" || $i == "Majestic" || $i ~ /^NADM/ || $i == "NSDM" || $i == "NODM" || $i == "Odyssey" || $i == "Ovation" || $i == "Regal" || $i == "Ruby" || $i == "Sky" || $i == "Sun" || $i == "VODM" || $i == "WEDM" || $i == "Sapphire" || $i == "ZUDM" || $i == "Royal")
        {
                print "<td>" $i"</td>"
        }
        else
...
) | sendmail chadhaabhishek93@gmail.com
